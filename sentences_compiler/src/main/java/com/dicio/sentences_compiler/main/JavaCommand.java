...
@Parameters(commandNames = {"java"}, commandDescription = "Compiler to Java: compiles every section to a com.dicio.component.input.standard.StandardRecognizer (from library dicio-assistance-component)")
